(function () {
  ...
  (function () {
    ...
    // --- КОНФИГУРАЦИЯ МИР КИНО ---
    const MIR_KINO_CONFIG = {
    ...
    function mkSearchMedia(query, callback) {
      ...
      const url = `${MIR_KINO_CONFIG.host}/Users/${MIR_KINO_CONFIG.userId}/Items?SearchTerm=${encodeURIComponent(cleanQuery)}&Recursive=true&IncludeItemTypes=Movie,Series,Episode&Fields=MediaSources,Path,ProductionYear&api_key=${MIR_KINO_CONFIG.apiKey}`;
    ...
    function _0x4cd5d3(_0x1140bc) {
      ...
      this.initialize = function () {
        ...
        return new Promise(function (_0x56a326, _0x35f966) {
          // Внедряем «Мир Кино» первейшей позицией в список источников
          _0x4bfca2 = {};
          _0x4bfca2['mirkino'] = {
            "url": "mirkino_local",
      ...
      // --- ПРЯМАЯ ОБРАБОТКА МИР КИНО КАК БАЛАНСЕРА ---
      this.findMirKino = function () {
        ...
        mkSmartSearch(_0x1140bc.movie, function (items) {
          ...
          const targetYear = mkExtractYear(_0x1140bc.movie);
          ...
          var formattedList = items.map(function (item) {
            ...
            if (item.MediaSources && item.MediaSources[0] && item.MediaSources[0].Path) {
              ...
              const extracted = path.split('\\').pop().split('/').pop();
            ...
            return {
              ...
              title: fileName,
              text: fileName,
              url: mkBuildStreamUrl(item),
              qualitys: { "4K 5.1": mkBuildStreamUrl(item) },
              voice_name: "Мир Кино"
            };
          });
      ...
      this.setDefaultQuality = function (_0x441523) {
        if (_0x441523.quality && Lampa.Arrays.getKeys(_0x441523.quality).length) for (var _0x5b402b in _0x441523.quality) {
          ...
          if (_0x441523.quality[_0x5b402b] && _0x441523.quality[_0x5b402b].indexOf(" or ") !== -1) _0x441523.quality[_0x5b402b] = _0x441523.quality[_0x5b402b].split(" or ")[0];
        }
      },
      ...
      this.selected = function (_0x3e9781) {
        ...
        _0x17b61f.chosen("filter", _0x38e9d2), _0x17b61f.chosen("sort", [_0x4bfca2[_0x4c45f6] ? _0x4bfca2[_0x4c45f6].name : _0x4c45f6]);
      },
